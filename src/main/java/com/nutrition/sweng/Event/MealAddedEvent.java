...
public class MealAddedEvent {
    ...
    public MealAddedEvent(){
    }

    public MealAddedEvent(Long id, Date date, MealCategory mealCategory, int calories, double fats, double carbs, double proteins, User userFk, Set<FoodEntry> foodEntries) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        MealAddedEvent that = (MealAddedEvent) o;
